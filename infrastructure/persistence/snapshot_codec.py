"""Private lossless codec for immutable product state snapshots."""
...
class SnapshotCodecError(ValueError):
    """Report an invalid persisted snapshot representation."""


def encode_snapshot(snapshot: StateSnapshot) -> dict[str, object]:
    """Encode a validated snapshot without losing Domain value precision."""
...
def decode_snapshot(value: object, storage_key: str) -> StateSnapshot:
    """Decode one snapshot and enforce its indexed product identity."""
